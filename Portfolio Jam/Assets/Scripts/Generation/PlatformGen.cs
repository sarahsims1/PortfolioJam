...
public class PlatformGen : MonoBehaviour
{
    ...
    private Platform queuedPlatform;
    private Collider currentCollider;
    private Collider queuedCollider;
    void Start()
    {
        platform = Instantiate(platforms[0], transform.localPosition, transform.rotation).GetComponent<Platform>();
        queuedPlatform = platforms[Random.Range(0,platforms.Length)].GetComponent<Platform>();
    ...
    void SpawnNew()
    {
        ...
        platform = Instantiate(queuedPlatform.gameObject, spawnPoint, transform.rotation).GetComponent<Platform>();
        queuedPlatform = platforms[Random.Range(0, platforms.Length)].GetComponent<Platform>();
        currentCollider = platform.GetComponent<Collider>();
        queuedCollider = queuedPlatform.GetComponent<Collider>();
    }
